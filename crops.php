...
<!--          <div class="android-section-title mdl-typography--display-1-color-contrast">Farmer's Store</div>-->
      ...
      <script type="text/javascript">
          $(document).ready(function() {
            ...
            $('#results').load("assets/fetch_crops.php", {'page':track_click}, function() {track_click++; }); //initial data to load
            ...
            $(".load_more").click(function (e) { //user clicks on button
              ...
              if(track_click <= total_pages) //make sure user clicks are still less than total pages
              {
                ...
                $.post('assets/fetch_crops.php',{'page': track_click}, function(data) {
                ...
                if(track_click >= total_pages-1)
                {
                  ...
                  $("#load_more_button").text("No more crops to be viewed!");
                }
               }
