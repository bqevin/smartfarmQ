	...
	if($message==2)
	 ...
	 ?>
      <div class="android-content mdl-layout__content">
        <a name="top"></a>
		  <div class="android-customized-section" style="background-image:url('images/n-fix-crops.jpg'); background-repeat:no-repeat; background-size:contain;">
          <div class="android-customized-section-text">
          	<hgroup>
            <div class="mdl-typography--font-light mdl-typography--display-1-color-contrast" style="padding:0px; margin:0px; color:#fff;">Register to be a smart farmer</div>	
			 <!--  <h1>Material Design Form</h1> -->
			  <h3 style="margin:0px; padding:0px;">get connected!</h3>
			</hgroup>
			<form method="post"action="assets/register_action.php">
			  <div class="group">
          ...
          <div class="android-customized-section-image" style="background-image:url('images/plain.jpg')"></div>
        </div>
