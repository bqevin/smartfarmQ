      ...
      <div class="android-content mdl-layout__content">
        <a name="top"></a>
          ...
          <div class="android-customized-section-text">
          	<hgroup>
            <div class="mdl-typography--font-light mdl-typography--display-1-color-contrast" style="padding:0px; margin:0px; color:#fff;">Avatar increases interaction probability!</div>	
			 <!--  <h1>Material Design Form</h1> -->
			  <h3 style="margin:0px; padding:0px;">Photos with a smile radiates positivity :)</h3>
			</hgroup>
			<form name="ppic_upload"method="post"action="assets/ppic_upload_action.php"enctype="multipart/form-data"/>
			 <input type="file" name="image"/><br><br>
			  <button type="submit" name ="sumit" class="button buttonBlue">Upload to finish
