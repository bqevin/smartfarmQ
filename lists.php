     ...
     <!--Menu Area-->
      ...
      <div class="android-content mdl-layout__content">
        ...
        <div class="android-more-section">
          <div class="android-section-title mdl-typography--display-1-color-contrast">More from Farm Store</div>
      ...
      <script type="text/javascript">
          $(document).ready(function() {
            ...
            $('#results').load("assets/fetch_items.php", {'page':track_click}, function() {track_click++; }); //initial data to load
            ...
            $(".load_more").click(function (e) { //user clicks on button
              ...
              if(track_click <= total_pages) //make sure user clicks are still less than total pages
              {
                ...
                $.post('assets/fetch_items.php',{'page': track_click}, function(data) {
